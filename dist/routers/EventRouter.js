...
class EventRouter {
    ...
    getRoutes() {
        ...
        this.router.get('/export-event', GlobalMiddleWare_1.GlobalMiddleWare.authenticate, EventController_1.EventController.exportEvent);
    ...
    patchRoutes() {
        this.router.patch('/update/:id', GlobalMiddleWare_1.GlobalMiddleWare.authenticate, new Utils_1.Utils().multer.array('file'), EventValidator_1.EventValidators.updateEvent(), GlobalMiddleWare_1.GlobalMiddleWare.checkError, EventController_1.EventController.updateEvent);
        this.router.patch('/finalsubmit/:id', GlobalMiddleWare_1.GlobalMiddleWare.authenticate, new Utils_1.Utils().multer.array('file'), EventValidator_1.EventValidators.finalsubmit(), GlobalMiddleWare_1.GlobalMiddleWare.checkError, EventController_1.EventController.finalSubmit);
    }
    deleteRoutes() {
